...
// import { User, LogOut, Menu, X, ShoppingCart, MessageSquare, Bell, Briefcase, LayoutDashboard, Moon, Sun } from "lucide-react";
...
//                             <Link to="/FreelancerDashboard" className="flex items-center px-4 py-2 text-sm text-black hover:bg-gray-100">
...
//           <div className="bg-white rounded-lg shadow-xl max-w-md mx-4 w-full p-6">
...
//       {showRegisterModal && (
//         <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
//           <div className="bg-white rounded-lg shadow-xl max-w-4xl mx-4 w-full overflow-auto max-h-[90vh]">
