...
//   // Dummy data for orders and transactions
...
//   // API fetch function for transactions
...
//   const handleApprove = () => {
//     // In a real implementation, you would call your API to update the transaction
//     console.log("Approving transaction:", selectedItem);
//     setIsApproveModalOpen(false);
//     // You could update the local state here to reflect the change
//   };

//   // Determine current data based on active view
//   const currentData = activeView === "orders" ? orders : transactions;
...
//   return (
//     <>
//       {/* Top Bar with Tabs (only for transactions) */}
//       <div className="flex items-center justify-between mb-6">
//         <h1 className="text-2xl font-bold">{pageTitle}</h1>
//         {activeView === "transactions" && (
//           <div>
//             <button className="bg-green-500 text-white px-4 py-2 rounded-l shadow hover:bg-green-600 focus:outline-none">
//               All Transactions
//             </button>
//             <button className="bg-green-300 text-white px-4 py-2 rounded-r shadow hover:bg-green-400 focus:outline-none">
...
//               Search by {activeView === "orders" ? "Order" : "Order"} Title
//             </label>
//             <input
//               type="text"
...
//                        <Eye size={18} />
//                     </button>
//                     {/* Approval tick icon (only for transactions) */}
//                     {activeView === "transactions" && (
//                       <button 
...
//                     {activeView === "orders" ? selectedItem.startDate : selectedItem.createdAt}
//                   </p>
//                 </div>
//                 <div>
...
//       {/* Modal for Approve Confirmation (only for transactions) */}
...
//                 This action cannot be undone. This will be permanently accepted.
//               </p>
//             </div>
//             {/* Modal Footer */}
