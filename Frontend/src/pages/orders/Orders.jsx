...
//                                   <>
//                                     <button
//                                       onClick={() => openSubmitWorkModal(order._id)}
...
//                               Drop files to upload or <span className="text-green-600">browse</span>
//                             </span>
//                           </>
//                         )}
//                       </span>
...
const Orders = () => {
  ...
  const renderStarRating = (value, hoverValue, onRatingChange, onHoverChange) => {
    return (
              ...
              <div className="space-y-6">
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-yellow-500 font-medium">
                    {rating > 0 ? `${rating.toFixed(1)} out of 5` : "Select a rating"}
                  </div>
                </div>
